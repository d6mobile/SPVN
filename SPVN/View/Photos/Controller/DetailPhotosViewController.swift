...
final class DetailPhotosViewController: BaseViewController {
    ...
    private let reuseIdentifier = "detailPhotosCell"
...
extension DetailPhotosViewController: CropViewControllerDelegate {
...
extension DetailPhotosViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDelegate {
...
extension DetailPhotosViewController : UIDocumentPickerDelegate {
